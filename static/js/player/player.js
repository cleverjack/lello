...
function PlayState() {
  ...
  this.init = function() {
    ...
    $(this.names.playpause).click(function() {
      player.togglePlayState();
    });

    $(this.names.next).click(function() {
      player.nextTrack();
    });

    $(this.names.prev).click(function() {
      player.prevTrack();
    });

    $(this.names.repeat).click(function() {
      player.toggleRepeat();
    });

    $(this.names.shuffle).click(function() {
  ...
  this.setScubElem = function(elem) {
    ...
    */
    ...
    .on('slide', function(slideEvt) {
      player.scrub_value = slideEvt.value;
      player.scrubTimeout();
    })
    .on('slideStop', function(slideEvt) {
      player.scrub_value = slideEvt.value;
      player.scrubTimeoutComplete();
    });
  };
  ...
  this.setVolElem = function(elem) {
    ...
    this.vol.slider()
    .on('slide', function() {
      this.setVolume(this.vol.slider('getValue'));
    }.bind(this))
