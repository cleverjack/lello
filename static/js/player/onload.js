(function() {
  ...
  */
  ...
  $('#soundcloud_fetch').click(function() {
    bootbox.prompt({
      ...
      callback: function(result) {
        if (result !== null) {
          socket.emit('soundcloud_download', {
            url: result
          });
        }
      },
  ...
  if (!music_dir_set) {
    showSettings('Welcome to lello Music Station! Please set me up with your music collection folders.');
  }
