...
function createOptions(x, y) {
  ...
  $('.remove_from_playlist').click(function(ev) {
    ...
    // update the server
    socket.emit('remove_from_playlist', {
  ...
  $('.similar_songs').click(function(ev) {
    ...
    socket.emit('similar_songs', {
      title: song.attributes.title,
      artist: song.attributes.display_artist,
      _id: song.attributes._id
    });
